    ...
    return (
        ...
        >
            ...
            <div className='flex gap-8 justify-center mt-4'>
                <button onClick={handleSubmit} type='submit' className='flex duration-200 justify-center bg-gray-600/50 border border-gray-400/20 items-center text-xs text-white rounded-sm py-1 px-4 hover:border-gray-400 hover:bg-gray-400'>Подтвердить</button>
                <Link to='/login'
